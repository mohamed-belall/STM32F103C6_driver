...
#define RCC_I2C1_Rest()			((RCC->APB1RSTR) |= 1<< 21)
#define RCC_I2C2_Rest()			((RCC->APB1RSTR) |= 1<< 22)
...
//I2C
#define NVIC_IRQ31_I2C1_EV_Enable			(NVIC_ISER0 |= ( 1 <<  I2C1_EV_IRQ      )) // I2C1_EV_IRQ
#define NVIC_IRQ32_I2C1_ER_Enable			(NVIC_ISER1 |= ( 1 << (I2C1_ER_IRQ -32) )) // I2C1_ER_IRQ-32
#define NVIC_IRQ33_I2C2_EV_Enable			(NVIC_ISER1 |= ( 1 << (I2C2_EV_IRQ -32) )) // I2C2_EV_IRQ-32
#define NVIC_IRQ34_I2C2_ER_Enable			(NVIC_ISER1 |= ( 1 << (I2C2_ER_IRQ -32) )) // I2C2_ER_IRQ-32

#define NVIC_IRQ31_I2C1_EV_Disable			(NVIC_ICER0 |= ( 1 <<  I2C1_EV_IRQ      )) // I2C1_EV_IRQ
#define NVIC_IRQ32_I2C1_ER_Disable			(NVIC_ICER1 |= ( 1 << (I2C1_ER_IRQ -32) )) // I2C1_ER_IRQ-32
#define NVIC_IRQ33_I2C2_EV_Disable			(NVIC_ICER1 |= ( 1 << (I2C2_EV_IRQ -32) )) // I2C2_EV_IRQ-32
#define NVIC_IRQ34_I2C2_ER_Disable			(NVIC_ICER1 |= ( 1 << (I2C2_ER_IRQ -32) )) // I2C2_ER_IRQ-32
